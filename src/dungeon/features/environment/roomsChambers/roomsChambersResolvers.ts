...
export function resolveRoomDimensions(options?: {
  ...
  switch (command) {
    case RoomDimensions.Square10x10:
      children.push(
        createPendingRoll({
          kind: 'numberOfExits',
          args: { kind: 'exits', length: 10, width: 10, isRoom: true },
        })
      );
      break;
    case RoomDimensions.Square20x20:
      children.push(
        createPendingRoll({
          kind: 'numberOfExits',
          args: { kind: 'exits', length: 20, width: 20, isRoom: true },
        })
      );
      break;
    case RoomDimensions.Square30x30:
      children.push(
        createPendingRoll({
          kind: 'numberOfExits',
          args: { kind: 'exits', length: 30, width: 30, isRoom: true },
        })
      );
      break;
    case RoomDimensions.Square40x40:
      children.push(
        createPendingRoll({
          kind: 'numberOfExits',
          args: { kind: 'exits', length: 40, width: 40, isRoom: true },
        })
      );
      break;
    case RoomDimensions.Rectangular10x20:
      children.push(
        createPendingRoll({
          kind: 'numberOfExits',
          args: { kind: 'exits', length: 10, width: 20, isRoom: true },
        })
      );
      break;
    case RoomDimensions.Rectangular20x30:
      children.push(
        createPendingRoll({
          kind: 'numberOfExits',
          args: { kind: 'exits', length: 20, width: 30, isRoom: true },
        })
      );
      break;
    case RoomDimensions.Rectangular20x40:
      children.push(
        createPendingRoll({
          kind: 'numberOfExits',
          args: { kind: 'exits', length: 20, width: 40, isRoom: true },
        })
      );
      break;
    case RoomDimensions.Rectangular30x40:
      children.push(
        createPendingRoll({
          kind: 'numberOfExits',
          args: { kind: 'exits', length: 30, width: 40, isRoom: true },
        })
      );
      break;
    case RoomDimensions.Unusual:
      ...
      children.push(
        createPendingRoll({
          kind: 'unusualSize',
          args: { kind: 'unusualSize', extra: 0, isRoom: true },
        })
      );
      break;
  }
  children.push(
    createPendingRoll({
      ...
      args: { kind: 'chamberContents', level: dungeonLevel },
    })
  );
  return {
    type: 'event',
  ...
  switch (command) {
    case ChamberDimensions.Square20x20:
      children.push(
        createPendingRoll({
          kind: 'numberOfExits',
          args: { kind: 'exits', length: 20, width: 20, isRoom: false },
        })
      );
      break;
    case ChamberDimensions.Square30x30:
      children.push(
        createPendingRoll({
          kind: 'numberOfExits',
          args: { kind: 'exits', length: 30, width: 30, isRoom: false },
        })
      );
      break;
    case ChamberDimensions.Square40x40:
      children.push(
        createPendingRoll({
          kind: 'numberOfExits',
          args: { kind: 'exits', length: 40, width: 40, isRoom: false },
        })
      );
      break;
    case ChamberDimensions.Rectangular20x30:
      children.push(
        createPendingRoll({
          kind: 'numberOfExits',
          args: { kind: 'exits', length: 20, width: 30, isRoom: false },
        })
      );
      break;
    case ChamberDimensions.Rectangular30x50:
      children.push(
        createPendingRoll({
          kind: 'numberOfExits',
          args: { kind: 'exits', length: 30, width: 50, isRoom: false },
        })
      );
      break;
    case ChamberDimensions.Rectangular40x60:
      children.push(
        createPendingRoll({
          kind: 'numberOfExits',
          args: { kind: 'exits', length: 40, width: 60, isRoom: false },
        })
      );
      break;
    case ChamberDimensions.Unusual:
      ...
      children.push(
        createPendingRoll({
          kind: 'unusualSize',
          args: { kind: 'unusualSize', extra: 0, isRoom: false },
        })
      );
      break;
  }
...
export function resolveChamberRoomContents(options?: {
  ...
  switch (command) {
    ...
    case ChamberRoomContents.Special:
      children.push(createPendingRoll({ kind: 'chamberRoomStairs' }));
      break;

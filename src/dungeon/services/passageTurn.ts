...
export const passageTurnResults = (): string => {
  ...
  if (command in PassageTurns) {
    console.log(`passageTurn roll: ${roll} is ${PassageTurns[command]}`);
    switch (command as PassageTurns) {
      case PassageTurns.Left90:
        return (
          "The passage turns left 90 degrees and extends 30'. " +
          passageWidthResults()
        );
      case PassageTurns.Left45:
        return (
          "The passage turns left 45 degrees ahead and extends 30'. " +
          passageWidthResults()
        );
      case PassageTurns.Left135:
        return (
          "The passage turns left 45 degrees behind (135 degrees) and extends 30'. " +
          passageWidthResults()
        );
      case PassageTurns.Right90:
        return (
          "The passage turns right 90 degrees and extends 30'. " +
          passageWidthResults()
        );
      case PassageTurns.Right45:
        return (
          "The passage turns right 45 degrees ahead and extends 30'. " +
          passageWidthResults()
        );
      case PassageTurns.Right135:
        return (
          "The passage turns right 45 degrees behind (135 degrees) and extends 30'. " +
          passageWidthResults()
        );
    }
  } else {
    return "oops, wrong command in PassageTurns";
  }
};

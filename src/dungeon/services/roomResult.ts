...
export const roomResult = (): string => {
  ...
  switch (command) {
    case RoomDimensions.Square10x10:
      return "The room is square and 10' x 10'. (TODO exits, contents, treasure) ";
    case RoomDimensions.Square20x20:
      return "The room is square and 20' x 20'. (TODO exits, contents, treasure) ";
    case RoomDimensions.Square30x30:
      return "The room is square and 30' x 30'. (TODO exits, contents, treasure) ";
    case RoomDimensions.Square40x40:
      return "The room is square and 40' x 40'. (TODO exits, contents, treasure) ";
    case RoomDimensions.Rectangular10x20:
      return "The room is rectangular and 10' x 20'. (TODO exits, contents, treasure) ";
    case RoomDimensions.Rectangular20x30:
      return "The room is rectangular and 20' x 30'. (TODO exits, contents, treasure) ";
    case RoomDimensions.Rectangular20x40:
      return "The room is rectangular and 20' x 40'. (TODO exits, contents, treasure) ";
    case RoomDimensions.Rectangular30x40:
      return "The room is rectangular and 30' x 40'. (TODO exits, contents, treasure) ";

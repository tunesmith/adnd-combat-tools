...
8. Typed subtables + roll trace

- Start migrating frequently used subtables to typed nodes (first: `passageWidth`).
- Add roll-trace node capturing primary and sub-rolls; render nested trace.
- Keep legacy string APIs for compatibility.
